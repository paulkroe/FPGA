...
HD_PWD='/home/paul/Documents/FPGA/dimmingLED/dimmingLED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dimLED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dimLED.tcl
